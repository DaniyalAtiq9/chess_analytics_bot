...
<!-- STATS:START -->
### Last updated: 2026-09-25 11:49 UTC

**Dataset:** 2412 rated games, 2023-02-16 to 2026-09-25
...
Based on 1517 inferred sessions, 2412 games. Position-vs-performance correlation: ρ=-0.033, p=0.1075 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.037 on average, p=0.0564 — not distinguishable from noise. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._

**Peak rating** (see `chess_analytics/milestones.py` — this is a moving target, updates as new games are added):

- **Blitz**: peak rating **906**, reached after 1031 of 1056 rated games, on 2026-09-21 — you've since come back down from it
