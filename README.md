...
<!-- STATS:START -->
### Last updated: 2026-08-10 08:04 UTC

**Dataset:** 2159 rated games, 2023-02-16 to 2026-08-10
...
Based on 1342 inferred sessions, 2159 games. Position-vs-performance correlation: ρ=-0.034, p=0.1169 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.038 on average, p=0.0627 — not distinguishable from noise. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._
