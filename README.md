...
**Dataset:** 2315 rated games, 2023-02-16 to 2026-09-07
...
Based on 1451 inferred sessions, 2315 games. Position-vs-performance correlation: ρ=-0.0294, p=0.1609 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.036 on average, p=0.0654 — not distinguishable from noise. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._

**Peak rating** (see `chess_analytics/milestones.py` — this is a moving target, updates as new games are added):

- **Blitz**: peak rating **890**, reached after 908 of 967 rated games, on 2026-08-30 — you've since come back down from it
