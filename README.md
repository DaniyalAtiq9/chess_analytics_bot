...
<!-- STATS:START -->
### Last updated: 2026-08-13 07:52 UTC

**Dataset:** 2187 rated games, 2023-02-16 to 2026-08-13
...
Based on 1357 inferred sessions, 2187 games. Position-vs-performance correlation: ρ=-0.0328, p=0.1282 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.037 on average, p=0.0631 — not distinguishable from noise. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._

**Peak rating** (see `chess_analytics/milestones.py` — this is a moving target, updates as new games are added):

- **Blitz**: peak rating **806**, reached after 849 of 849 rated games, on 2026-08-13 — that's still your peak right now
