...
<!-- STATS:START -->
### Last updated: 2026-08-20 07:05 UTC

**Dataset:** 2203 rated games, 2023-02-16 to 2026-08-19
...
Based on 1370 inferred sessions, 2203 games. Position-vs-performance correlation: ρ=-0.0303, p=0.1587 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.035 on average, p=0.0825 — not distinguishable from noise. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._

**Peak rating** (see `chess_analytics/milestones.py` — this is a moving target, updates as new games are added):

- **Blitz**: peak rating **822**, reached after 851 of 860 rated games, on 2026-08-13 — you've since come back down from it
