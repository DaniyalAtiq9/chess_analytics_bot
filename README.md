...
**Dataset:** 2208 rated games, 2023-02-16 to 2026-08-23
...
Based on 1375 inferred sessions, 2208 games. Position-vs-performance correlation: ρ=-0.0297, p=0.1666 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.035 on average, p=0.0838 — not distinguishable from noise. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._

**Peak rating** (see `chess_analytics/milestones.py` — this is a moving target, updates as new games are added):

- **Blitz**: peak rating **822**, reached after 851 of 865 rated games, on 2026-08-13 — you've since come back down from it
