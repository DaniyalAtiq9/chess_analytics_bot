...
<!-- STATS:START -->
### Last updated: 2026-09-22 11:36 UTC

**Dataset:** 2395 rated games, 2023-02-16 to 2026-09-22
...
Based on 1506 inferred sessions, 2395 games. Position-vs-performance correlation: ρ=-0.0336, p=0.1024 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.038 on average, p=0.0486 — a statistically real step-change. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._

**Peak rating** (see `chess_analytics/milestones.py` — this is a moving target, updates as new games are added):

- **Blitz**: peak rating **906**, reached after 1031 of 1040 rated games, on 2026-09-21 — you've since come back down from it
