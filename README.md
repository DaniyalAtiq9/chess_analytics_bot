...
<!-- STATS:START -->
### Last updated: 2026-09-11 11:19 UTC

**Dataset:** 2332 rated games, 2023-02-16 to 2026-09-09
...
Based on 1462 inferred sessions, 2332 games. Position-vs-performance correlation: ρ=-0.0302, p=0.1483 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.037 on average, p=0.0605 — not distinguishable from noise. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._

**Peak rating** (see `chess_analytics/milestones.py` — this is a moving target, updates as new games are added):

- **Blitz**: peak rating **890**, reached after 908 of 984 rated games, on 2026-08-30 — you've since come back down from it
