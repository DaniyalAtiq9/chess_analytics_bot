...
<!-- STATS:START -->
### Last updated: 2026-09-21 12:46 UTC

**Dataset:** 2383 rated games, 2023-02-16 to 2026-09-21
...
Based on 1501 inferred sessions, 2383 games. Position-vs-performance correlation: ρ=-0.031, p=0.133 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.037 on average, p=0.0538 — not distinguishable from noise. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._

**Peak rating** (see `chess_analytics/milestones.py` — this is a moving target, updates as new games are added):

- **Blitz**: peak rating **898**, reached after 1028 of 1028 rated games, on 2026-09-21 — that's still your peak right now
