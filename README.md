...
<!-- STATS:START -->
### Last updated: 2026-09-15 11:42 UTC

**Dataset:** 2346 rated games, 2023-02-16 to 2026-09-14
...
Based on 1474 inferred sessions, 2346 games. Position-vs-performance correlation: ρ=-0.0307, p=0.1399 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.038 on average, p=0.0544 — not distinguishable from noise. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._

**Peak rating** (see `chess_analytics/milestones.py` — this is a moving target, updates as new games are added):

- **Blitz**: peak rating **890**, reached after 908 of 995 rated games, on 2026-08-30 — you've since come back down from it
