...
**Dataset:** 2343 rated games, 2023-02-16 to 2026-09-12
...
Based on 1471 inferred sessions, 2343 games. Position-vs-performance correlation: ρ=-0.0302, p=0.1466 — not distinguishable from no trend. First game of session vs. later games: later games score worse by 0.037 on average, p=0.0563 — not distinguishable from noise. _Both tests use α=0.05 uncorrected for this specific comparison — treat a single borderline p-value as a lead to watch over time, not a confirmed effect, same caveat as the country analysis._
